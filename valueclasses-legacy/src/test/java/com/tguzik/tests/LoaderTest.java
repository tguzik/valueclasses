...
class LoaderTest {
  ...
  @Test
  void loadFile_returns_the_content_of_given_file() throws IOException {
  ...
  @Test
  void loadFile_all_function_variants_return_the_same_content() throws IOException {
    ...
    final String usingPrefixDirSubdirAndFilename = loadFile( "src/test/java", "com/tguzik/tests", "data", "test-file.txt" );
